...
namespace LibraryMVC.Controllers
{
    public class LibraryBooksController : Controller
    {
        ...
        {
            var libraryMVCContext = _context.LibraryBooks.Include(l => l.Book).Include(l=>l.Library).Where(d => d.Book.Title.Contains(search) || d.ISBN==search);
            return View(await libraryMVCContext.ToListAsync());
        ...
        public IActionResult Create()
        {
           ...
           // ViewData["Title"] = new SelectList(_context.Book, "ISBN", "Title");
