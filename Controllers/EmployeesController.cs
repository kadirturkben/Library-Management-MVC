...
namespace LibraryMVC.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Edit(long? id)
        {
            ...
            var employee = await _context.Employee.Include(l => l.Library).Include(x=>x.Library.District)
                .FirstOrDefaultAsync(m => m.Id == id);
            if (employee == null)
            {
                return NotFound();
            }
            ViewData["CityId"] = new SelectList(_context.City, "PlateCode", "Name", employee.Library.District.CityId);
            ViewData["DistrictId"] = new SelectList(_context.District.Where(d => d.CityId == employee.Library.District.CityId), "Id", "Name", employee.Library.DistrictId);
            ViewData["LibraryId"] = new SelectList(_context.Library, "Id", "Name", employee.LibraryId);
            return View(employee);
        }
